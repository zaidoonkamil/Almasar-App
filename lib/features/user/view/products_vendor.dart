                  ...
                  ConditionalBuilder(
                    ...
                    builder: (c) {
                      return ConditionalBuilder(
                        condition:
                            cubit.productsVendorModel!.products.isNotEmpty,
                        builder: (c) {
                          return Expanded(
                                                              ...
                                                              content: Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  ElevatedButton(
                                                                    ...
                                                                    onPressed: () {
                                                                      cubit.deleteProductsInOfVendor(
                                                                        context:
                                                                            context,
                                                                        vendorId:
                                                                            idVendor,
                                                                        productId:
                                                                            cubit.productsVendorModel!.products[index].id.toString(),
                                                                      );
                                                                    },
                                                                    child: Text(
                                                                      "نعم",
