...
class Details extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => UserCubit(), //..createDatabase(),
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: 4),
                                            Image.asset(
                                              'assets/images/solar_calendar-broken (1).png',
                                              width: 20,
                                              height: 20,
                                            ),
                                          ],
                                ...
                                onTap: () {
                                  if (token != '') {
                                    if (adminOrUser == 'admin') {
                                      showToastInfo(
                                        text: 'سجل عن طريق تطبييق المستخدم',
                                        context: context,
                                      );
                                    } else {
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Image.asset(
                                        'assets/images/shopping-cart-02 (1).png',
                                      ),
                                    ],
                                  ),
                                ),
