...
class _HomeState extends State<Home> {
  ...
  void _onSearchChanged() {
    ...
    print(
      '🔎 _onSearchChanged fired, text="$text", cubitReady=${cubit != null}',
    );
    setState(() {
                                  ...
                                  onNotification: (
                                    ...
                                    if (scrollInfo
                                        ...
                                        !(cubit.isVendorLoadingMore ||
                                            cubit.isVendorSearchLoadingMore)) {
                                      int nextPage =
                                          cubit
                                              .vendorModel!
                                              .paginationVendor
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Row(
                                                                    children: [
                                                                      ...
                                                                      Image.asset(
                                                                        'assets/images/solar_fire-bold.png',
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ),
