...
class AdminCubit extends Cubit<AdminStates> {
  ...
  void getNameUser({required BuildContext? context, required String role}) {
    ...
    DioHelper.getData(url: '/users$role')
        .then((value) {
  ...
  void getDashboardAdmin({BuildContext? context}) {
    ...
    DioHelper.getData(url: '/admin/dashboard')
        .then((value) {
  ...
  void getTodayDashboardAdmin({BuildContext? context}) {
    ...
    DioHelper.getData(url: '/admin/today-dashboard')
        .then((value) {
  ...
  void getLatAndLong({required BuildContext context, required String id}) {
    ...
    DioHelper.getData(url: '/delivery-locations/$id')
        .then((value) {
        ...
        .catchError((error) {
          if (error is DioException) {
            showToastError(text: 'خطأ في جلب الموقع', context: context);
            print(error.toString());
  ...
  void openMap({required BuildContext context}) async {
    if (lat != null && long != null) {
      ...
      showToastError(text: 'لا يمكن فتح الخريطة', context: context);
    }
  }
  ...
  void getActiveOrder({required BuildContext context}) {
    ...
    DioHelper.getData(url: '/admin/order-pending')
        .then((value) {
          if (isClosed) return;
  ...
  void getActiveDelivery({required BuildContext context}) {
    ...
    DioHelper.getData(url: '/admin/delivery-active')
        .then((value) {
          List<GetActiveDeliveryModel> newData =
              (value.data as List)
  ...
  deliveriesAssignOrder({
    ...
    DioHelper.putData(
        ...
        .then((value) {
          ...
          showToastSuccess(text: "تم توجيه الطلب بنجاح", context: context);
  ...
  void sponsorshipVendor({
    required BuildContext context,
    required String id,
    required String sponsorshipAmount,
  }) {
  ...
  void addNotification({
    ...
    if (role.isNotEmpty) {
      ...
      data = {'title': title, 'message': desc, 'role': role};
    } else {
      url = '/send-notification';
      data = {'title': title, 'message': desc};
    }
    DioHelper.postData(url: url, data: data)
        .then((value) {
