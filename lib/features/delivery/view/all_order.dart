...
class AllOrdersDelivery extends StatelessWidget {
  const AllOrdersDelivery({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => DeliveryCubit()..getOrder(page: '1',context: context),
                  ...
                  ConditionalBuilder(
                    ...
                    builder: (c){
                      return ConditionalBuilder(
                          condition: true,//state is! GetOrderLoadingState,
                          builder: (c){
                            return Expanded(
