              ...
              body: Column(
                children: [
                  ...
                  ConditionalBuilder(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                DateTime dateTime = DateTime.parse(
                                  cubit.getActiveOrdersModel![index].createdAt
                                      .toString(),
                                );
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () async {
                                                final url =
                                                    'tel:${cubit.getActiveOrdersModel![index].phone}';
                                                await launch(
                                                  url,
                                        ...
                                        Row(
                                          mainAxisAlignment:
                                              MainAxisAlignment.spaceBetween,
                                          children: [
                                            cubit.getActiveOrdersModel![index].items !=
                                                        null &&
                                                    cubit
                                                        .getActiveOrdersModel![index]
                                                        .items!
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: () async {
                                                        final url =
                                                            'tel:${cubit.getActiveOrdersModel![index].vendor.phone}';
                                                        await launch(
                                                          url,
                                                          enableJavaScript:
                                                              true,
                                                                          ...
                                                                          onPressed: () {
                                                                            if (noteController.text.trim() ==
                                                                              ...
                                                                              cubit.deliveryAccept(
                                                                                ...
                                                                                idOrder:
                                                                                    cubit.getActiveOrdersModel![index].id.toString(),
                                                                              );
                                                                              navigateBack(
                                                                                context,
                                                                              );
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ConditionalBuilder(
                                              condition:
                                                  state
                                                      is! ChangeStatusOrderLoadingState,
                                              builder:
                                                  (c) => GestureDetector(
                                                    onTap: () {
                                                      showDialog(
                                                        ...
                                                        builder: (
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            title: Text(
                                                              "هل حقا ترغب في تغيير الحالة الى (تم التسليم) ؟",
                                                              style: TextStyle(
                                                                fontSize: 18,
                                                              ),
                                                              textAlign:
                                                        ...
                                                        builder: (
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            title: Column(
                                                              children: [
                                                                Text(
                                                                  "هل حقا ترغب في تغيير الحالة الى (تبديل الطلب) ؟",
                                                                  style:
                                                                      TextStyle(
                                                                        fontSize:
                                                                            18,
                                                        ...
                                                        builder: (
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            title: Column(
                                                              children: [
                                                                Text(
                                                                  "هل حقا ترغب في تغيير الحالة الى (استرجاع الطلب) ؟",
                                                                  style:
                                                                      TextStyle(
                                                                        fontSize:
                                                                            18,
                    ...
                    fallback:
                        (c) =>
                            Expanded(child: Center(child: CircularProgress())),
                  ),
                ],
              ),
            ),
