    ...
    return BlocProvider(
      create:
          (BuildContext context) =>
              DeliveryCubit()..getDashboardDelivery(context: context),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  StatCard(
                                    ...
                                    icon:
                                        'material-symbols_cancel-outline-rounded.png',
                                    total: cubit.getDashboard!.orderCount,
                                    used:
                                        cubit
                                            .getDashboard!
                                    ...
                                    Expanded(
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            cubit.getDashboard!.deliveryFee
                                                    .toString() ??
                                                '0',
                                            style: TextStyle(
                                              fontSize: 20,
                                      ...
                                      children: [
                                        ...
                                        Stack(
                                          ...
                                          children: [
                                            ...
                                            Image.asset(
                                              'assets/images/carbon_cur2rency.png',
                                            ),
                                          ],
                                        ),
                                      ],
                              ...
                              Row(
                                ...
                                children: [
                                  StatCard(
                                    label: 'رسوم التوصيل',
                                    icon:
                                        'healthicons_vespa-motorcycle-outline.png',
                                    total:
                                        cubit
                                            .getDashboard!
                                            .totalAmountIncludingFee,
