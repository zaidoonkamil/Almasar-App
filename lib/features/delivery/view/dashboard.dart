...
class DashboardDelivery extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => DeliveryCubit()..getDashboardDelivery(context: context),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      StatCard(
                                        ...
                                        total: cubit.getDashboard!.orderCount,
                                        used:  cubit.getDashboard!.deliveredOrderComplet,
                                        color: Colors.green,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total:  cubit.getDashboard!.orderCount,
                                        used:   cubit.getDashboard!.deliveredOrderExchange,
                                        color: Colors.yellow,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total: cubit.getDashboard!.orderCount,
                                        used:  cubit.getDashboard!.deliveredOrderCancelled,
                                        color: primaryColor,
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      StatCard(
                                        ...
                                        total: cubit.getDashboard!.totalAmountIncludingFee,
                                        used:  cubit.getDashboard!.totalAmountIncludingFee,
                                        color: Colors.blue,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total: cubit.getDashboard!.orderCount,
                                        used:  cubit.getDashboard!.orderCount,
                                        color: Colors.deepOrangeAccent,
                                      ),
