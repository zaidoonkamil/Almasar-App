...
class TodayDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => DeliveryCubit()..getTodayDashboardDelivery(context: context),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      StatCard(
                                        ...
                                        total: cubit.getTodayDashboard!.orderCount,
                                        used:  cubit.getTodayDashboard!.deliveredOrderComplet,
                                        color: Colors.green,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total:  cubit.getTodayDashboard!.orderCount,
                                        used:   cubit.getTodayDashboard!.deliveredOrderExchange,
                                        color: Colors.yellow,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total: cubit.getTodayDashboard!.orderCount,
                                        used:  cubit.getTodayDashboard!.deliveredOrderCancelled,
                                        color: primaryColor,
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      StatCard(
                                        ...
                                        total: cubit.getTodayDashboard!.totalAmountIncludingFee,
                                        used:  cubit.getTodayDashboard!.totalAmountIncludingFee,
                                        color: Colors.blue,
                                      ),
                                      SizedBox(width: 10,),
                                      StatCard(
                                        ...
                                        total: cubit.getTodayDashboard!.orderCount,
                                        used:  cubit.getTodayDashboard!.orderCount,
                                        color: Colors.deepOrangeAccent,
                                      ),
